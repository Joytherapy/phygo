...
const description =
  'Cientos de condiciones clínicas — ortopédicas, neurológicas, cardiopulmonares, oncológicas — con objetivos de rehabilitación, pruebas clínicas, señales de alarma y ejercicios típicos, verificadas con literatura científica actualizada.';

export const metadata: Metadata = {
  title: 'Biblioteca Clínica — Condiciones y Patologías | Phygo',
  description,
  alternates: {
    canonical: `${SITE_URL}/es/library/condition`,
    languages: {
  ...
  openGraph: {
    title: 'Biblioteca Clínica — Condiciones y Patologías | Phygo',
    description,
    url: `${SITE_URL}/es/library/condition`,
    type: 'website',
  },
};

export default async function ConditionLibraryIndexPageES() {
      ...
      <div className="relative max-w-4xl mx-auto px-6 pt-40 pb-24">
        <div className="text-center mb-14">
          ...
          <div className="flex justify-center mt-5">
            <LanguageSwitcher current="es" hrefFor={(lang) => buildConditionIndexPath(lang)} />
          </div>
        </div>

        <ConditionSearchList items={conditions} lang="es" />
      </div>
