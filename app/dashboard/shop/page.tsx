  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-[#08090b] overflow-hidden transition-colors">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(79,124,255,0.6) 0%, rgba(244,114,182,0.4) 50%, rgba(50,214,160,0.5) 100%)' }}
      />
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="mb-3">
                    <ClinicalActionBar
                      ...
                      payload={{ name: product.name, amazonUrl: product.amazonUrl, price: product.price }}
                    />
                  </div>
